  ...
  return (
    <>
      <div className="flex flex-col min-h-screen bg-gradient-to-tr from-[#18192B] via-[#2B2256] to-[#4B3B8B] px-8 py-6 relative">
        ...
        <div className="absolute right-0 top-0 w-[500px] h-[500px] bg-gradient-to-br from-purple-500 via-fuchsia-500 to-pink-500 opacity-40 blur-3xl rounded-full pointer-events-none z-0" />
        <div className="absolute left-0 bottom-0 w-[500px] h-[500px] bg-gradient-to-br from-purple-500 via-fuchsia-500 to-pink-500 opacity-40 blur-3xl rounded-full pointer-events-none z-0" />
        ...
        <div className='text-center mt-8 max-w-2xl mx-auto'>
          ...
          <button className='mt-8 bg-pink-500 text-white px-6 py-3 rounded-full border border-[#e5e5e5] hover:bg-[#e5e5e5] hover:text-black transition duration-300'>
            Get Started
          </button>
          <button className='mt-8 mr-4 ml-3 bg-pink-500 text-white px-6 py-3 rounded-full border border-[#e5e5e5] hover:bg-[#e5e5e5] hover:text-black transition duration-300'>
            Learn More
          </button>
        </div>
      </div>
