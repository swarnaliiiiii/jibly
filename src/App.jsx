  ...
  return (
    <>
      <div className="flex flex-col min-h-screen bg-slate-900 px-8 py-6 relative">
        ...
        <button className="rounded-full text-glow bg-pink-500 text-white border border-[#e5e5e5] mt-3 mr-13 px-4 py-2 absolute top-4 right-4 hover:bg-[#e5e5e5] hover:text-black transition duration-300 ease-in-out shadow-lg shadow-pink-500/90">
          Sign Up
        </button>
        ...
        <div className='text-center mt-8 max-w-2xl mx-auto'>
          ...
          <button className='mt-8 bg-pink-500 text-glow text-white px-6 py-3 rounded-full border border-[#e5e5e5] hover:bg-[#e5e5e5] hover:text-black transition duration-300'>
            Get Started
          </button>
          <button className='mt-8 mr-4 ml-3 bg-pink-500 text-glow text-white px-6 py-3 rounded-full border border-[#e5e5e5] hover:bg-[#e5e5e5] hover:text-black transition duration-300'>
            Learn More
          </button>
        </div>
